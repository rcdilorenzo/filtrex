defmodule FiltrexTest do
  ...
  test "creating a filter with a datetime expression" do
    params =
      FilterParams.build(:all)
      |> FilterParams.conditions([
        ConditionParams.build(:datetime,
          comparator: "on or after",
          value: "2016-03-20T12:34:58.000Z"
        ),
        ConditionParams.build(:datetime,
          comparator: "on or before",
  ...
  test "parsing parameters" do
    query_string =
      "title_contains=earth&date_column_between[start]=2016-01-10&date_column_between[end]=2016-12-10&flag=false&filter_union=any"
