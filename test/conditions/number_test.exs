defmodule FiltrexConditionNumberTest do
  ...
  defp params(comparator, value) do
    %{inverse: false, column: @column, value: value, comparator: comparator}
  end

  defp condition(comparator, value) do
    %Number{type: :number, column: @column, inverse: false, comparator: comparator, value: value}
  end
end
